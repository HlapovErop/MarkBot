...
# COPY говорит, что мы какие файлы из проекта или нашего компьютера нужно перенести в контейнер (тк изначально он пустой). Первая точка означает, что мы копируем эту директорию на компютере (где проект и все дела). Вторая точка - куда, в нашем случае в рабочую директорию контейнера - /usr/src/app
COPY . .
